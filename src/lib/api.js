// Em build web normal, usa caminho relativo '/api' (mesmo domínio do Vercel).
// Em build mobile (Capacitor), o WebView não tem domínio próprio, então
// é necessário apontar para a URL pública do backend implantado no Vercel.
// Configure VITE_API_BASE_URL no arquivo .env (ex: https://seu-projeto.vercel.app/api)
